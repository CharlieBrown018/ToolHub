      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <GlassCard hover={false} animated={false} className="border-pink-500/30">
              <GlassCardHeader>
                <GlassCardTitle>QR Content</GlassCardTitle>
              </GlassCardHeader>
              <GlassCardContent className="space-y-4">
                <div className="flex gap-2">
                  <button className="flex-1 py-2 rounded-lg bg-pink-500/20 text-pink-400 border border-pink-500/30 text-xs font-bold flex items-center justify-center gap-2">
                ...
                <textarea
                  ...
                  className="w-full h-32 bg-glass-white-md backdrop-blur-md border border-glass-border rounded-xl p-4 text-gray-100 focus:outline-none focus:ring-2 focus:ring-pink-500/30 resize-none"
                />
              </GlassCardContent>
            </GlassCard>
              ...
              <GlassCardContent className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-xs text-pink-400 font-bold">{size}px</span>
                  </div>
                  <input
                    type="range"
                    min="128"
                    ...
                    className="w-full h-2 bg-glass-white-lg rounded-lg appearance-none cursor-pointer accent-pink-500"
                  />
                </div>
              </GlassCardContent>
            </GlassCard>
          ...
          <div className="space-y-6">
            <GlassCard hover={false} animated={false} className="border-pink-500/30 h-full flex flex-col">
              <GlassCardHeader>
              ...
              <GlassCardContent className="flex-1 flex flex-col items-center justify-center space-y-8 pb-12">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-pink-500/10 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl flex items-center justify-center">
                    <ShareNetwork className="h-10 w-10 text-pink-500" />
                  </div>
                </div>

                <div className="w-full max-w-xs space-y-3">
                  <GlassButton variant="pink" className="w-full py-6" onClick={handleDownload}>
